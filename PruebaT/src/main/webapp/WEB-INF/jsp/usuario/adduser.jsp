                ...
                <div class="nav-wrapper">
                    <a href="home.htm" class="brand-logo"><span class="lime-text text-accent-1">Prueba Seratic</span></a>
                     <ul id="nav-mobile" class="right hide-on-med-and-down">
                        ...
                        <li><a href="aspirante.htm"><span class="lime-text text-accent-2">Aspirantes</span></a></li>
                        <li><a href="pruebas.htm"><span class="lime-text text-accent-2">Pruebas</span></a></li>
            ...
            <form:form method="post" modelAttribute="usuario">                           
                <div class="row">
                    <div class="input-field col s6">
                        ...
                        <form:input id="icon_prefix" path="idusuario" type="text" class="validate" required="true" aria-required="true"/>
                        <form:label for="icon_prefix" path="idusuario">Cedula</form:label>                        
                    </div>
                    <div class="input-field col s6">
